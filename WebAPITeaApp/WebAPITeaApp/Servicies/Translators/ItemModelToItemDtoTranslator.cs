    ...
    public class ItemModelToItemDtoTranslator: AutomapperTranslator<Item, ItemDto>
    {
        ...
        public override void Configure()
        {
            ...
            Mapping
                ...
                .ForMember(m => m.CategoryId,           o => o.MapFrom(m => m.Category == null ? (int?)null : m.Category.CategoryId ))
                .ForMember(m => m.ManufacterId,         o => o.MapFrom(m => m.Manufacter == null ? (int?)null :m.Manufacter.ManufacterId));
